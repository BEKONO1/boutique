        ...
        defaults: {
            ...
            if (t(e).length) {
                ...
                if (o.setView(i.map.coords, i.map.zoom),
                    // Use Mapbox if token exists, otherwise fallback to OpenStreetMap
                    i.layer.token && i.layer.token.includes('YOUR_MAPBOX_TOKEN') === false ?
                    L.tileLayer(i.layer.token, i.layer).addTo(o) :
                    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                        attribution: '&copy; OpenStreetMap contributors',
                        maxZoom: 18
                    }).addTo(o),
                i.marker) for (var r = 0; r < i.marker.length; r++) {
